...
crd0   = [ 0 0; 1 0; 2 0];
eldata = [ 1 2  1 0 1 ; 2 3  0 1 1 ];
pp     = [ 1 1 0 ; 1 2 0 ; 2 2 0 ; 3 2 0 ];
pf     = [ 3 1 0.1 ];
map    = [];

nic=50; ts=0.1; im=6; Ga=0.25; Gd=0.5; nl=0; mit=1; ccr=0.01;
...
fprintf(sada,'tim(ic+1)=ti;       ux3(ic+1)=MTp(3,1); \n'); 
fprintf(sada,'fx3(ic+1)=Mfi(3,1); kx3(ic+1)=Mfe(3,1); \n');
fclose(sada);
