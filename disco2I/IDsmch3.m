...
eldata(11,:)=[11 12 1e-2 1e1 1];
pp      = [ 1 1 0; 1 2 0; 11 2 0; 12 1 0; 12 2 0 ];
pf      = [ 
...
fprintf(plda,'subplot(221);load([matf num2str(50)]); \n');
fprintf(plda,'plotmesh(mshop,loka,crd0,crd,eldaC,2); \n');
fprintf(plda,'subplot(222);load([matf num2str(150)]); \n');
fprintf(plda,'plotmesh(mshop,loka,crd0,crd,eldaC,2); \n');
fprintf(plda,'subplot(223);load([matf num2str(500)]); \n');
fprintf(plda,'plotmesh(mshop,loka,crd0,crd,eldaC,2); \n');
fprintf(plda,'subplot(224);plot(tim,f1);grid on; \n');
